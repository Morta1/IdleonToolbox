...
import { Container, Dialog, DialogContent, DialogTitle, Divider, Grid, Link, Stack, Typography, useMediaQuery } from "@mui/material";
  ...
  return (
    <Container>
      ...
      <Typography style={{ textAlign: "center" }} variant={"body2"}>
        For any question, suggestion or bug report, please contact me in discord <span style={{ fontWeight: "bold" }}>Morojo#2331</span> or open an issue on <Link href="https://github.com/Morta1/IdleonToolbox/issues">github</Link>
      </Typography>
      <Stack direction={fullScreen ? "column" : "row"} alignItems="flex-start" flexWrap={"wrap"} justifyContent="center" spacing={2} style={{ margin: "35px 0" }}>
...
const svgs = {
  purple: (
    <svg style={{ flexShrink: 0, fill: "hsl(250, 84%, 67%)", width: 24, height: 24 }} viewBox="0 0 24 24" aria-hidden="true">
  ...
  green: (
    <svg style={{ flexShrink: 0, fill: "hsl(120, 50%, 69%)", width: 24, height: 24 }} viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="12" cy="12" r="12" opacity="0.2" />
      <path d="M17,11H13V7a1,1,0,0,0-2,0v4H7a1,1,0,0,0,0,2h4v4a1,1,0,0,0,2,0V13h4a1,1,0,0,0,0-2Z" />
    </svg>
  ),
  red: (
    <svg style={{ flexShrink: 0, fill: "hsl(342, 89%, 62%)", width: 24, height: 24 }} className="list__icon icon color-error" viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="12" cy="12" r="12" opacity="0.2" />

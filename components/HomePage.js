      ...
      changes: [
        {
          title: 'General',
          desc: [
            'Fixed a bug crashing the website when calculating lab. (Lab is still not accurate, I\'m working on it)',
          ]
        }
      ]
    },
      ...
      changes: [
        {
          title: 'Laboratory',
          desc: [
            'Showing an overview of the laboratory + lab bonuses + jewels'
          ]
        }
      ]
    },

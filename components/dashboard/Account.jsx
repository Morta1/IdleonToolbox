...
import { Divider, Group, HoverCard, Paper, Text } from '@mantine/core';
  ...
  return <Paper withBorder shadow="xs" p="md">
    {alerts ? <Stack divider={<Divider/>} gap={1.5}>
      ...
      {!emptyAlertRows?.['World 1'] ? <Stack direction={'row'} gap={4}>
        <Text style={{ flexShrink: 0 }}>World 1</Text>
        <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
      ...
      {!emptyAlertRows?.['World 2'] ? <Stack direction={'row'} gap={4}>
        <Text style={{ flexShrink: 0 }}>World 2</Text>
        <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
      ...
      {!emptyAlertRows?.['World 3'] ? <Stack direction={'row'} gap={4}>
        <Text style={{ flexShrink: 0 }}>World 3</Text>
        <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
      ...
      {!emptyAlertRows?.['World 4'] ? <Stack direction={'row'} gap={4}>
        <Text style={{ flexShrink: 0 }}>World 4</Text>
        <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
      ...
      {!emptyAlertRows?.['World 5'] ? <Stack direction={'row'} gap={4}>
        <Text style={{ flexShrink: 0 }}>World 5</Text>
        <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
      ...
      {!emptyAlertRows?.['World 6'] ? <Stack direction={'row'} gap={4}>
        <Text style={{ flexShrink: 0 }}>World 6</Text>
        <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
...
const Alert = ({ title, iconPath, vial, atom, style = {}, imgStyle = {}, onError = () => {} }) => {
  return <Group justify="center">
    <HoverCard closeDelay={0} withArrow arrowSize={12} shadow={'sm'} withinPortal={false}>
      <HoverCard.Target>

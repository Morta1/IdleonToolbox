          ...
          <Stack direction={'row'} gap={4}>
            ...
            <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
              {alerts?.['World 2']?.islands?.unclaimedDays ?
                <Alert title={`You haven't claimed your islands' content in ${alerts?.['World 2']?.islands?.unclaimedDays} days`}
          ...
          <Stack direction={'row'} gap={4}>
            ...
            <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
              {alerts?.['World 3']?.atomCollider?.stampReducer ?
                <Alert title={`Stamp reducer has reached your threshold (${alerts?.['World 3']?.atomCollider?.stampReducerValue}%)`}
                       iconPath={'data/Atom0'}/> : null}
              {alerts?.['World 3']?.construction?.flags?.length > 0 ?
                <Alert title={`There are ${alerts?.['World 3']?.construction?.flags?.length} flags finished in construction board`}
          ...
          <Stack direction={'row'} gap={4}>
            ...
            <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
              ...
              {alerts?.['World 4']?.breeding?.shinies?.pets?.length > 0 ?
                alerts?.['World 4']?.breeding?.shinies?.pets?.map(({ monsterName, monsterRawName, shinyLevel, icon }, index) => {
          ...
          <Stack direction={'row'} gap={4}>
            ...
            <Stack direction={'row'} gap={2} flexWrap={'wrap'}>
              ...
              {alerts?.['World 5']?.gaming?.squirrel?.hours >= 1 ?
                <Alert title={`${alerts?.['World 5']?.gaming?.squirrel?.hours} hours has passed since you've clicked the squirrel`}
                       iconPath={'data/GamingItem2'}/> : null}
              {alerts?.['World 5']?.gaming?.shovel?.hours >= 1 ?
                <Alert title={`${alerts?.['World 5']?.gaming?.shovel?.hours} hours has passed since you've clicked the shovel`}

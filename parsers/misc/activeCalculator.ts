...
export const getExpForLevel = (level: any) => {
...
export const getExpToLevel = (character: any, targetLevel: any) => {
...
export const getExpDiff = (snapshot: any, current: any, lastUpdated: any) => {
...
export const compareInventories = (snapshotInventory: any, currentInventory: any, lastUpdated: any, snapshotTime: any, goal: any) => {
...
export const compareCards = (snapshot: any, current: any, lastUpdated: any, snapshotTime: any) => {
  if (!snapshot || !current) return [];
  const timeDiff = (lastUpdated - snapshotTime) / 3600000; // Convert ms to hours

  return Object.entries(current).reduce((result: any[], [cardId, card]: any) => {
